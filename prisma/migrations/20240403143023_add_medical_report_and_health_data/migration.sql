...
-- CreateIndex
CREATE UNIQUE INDEX "patient_health_status_patientId_key" ON "patient_health_status"("patientId");

-- AddForeignKey
ALTER TABLE "patient_health_status" ADD CONSTRAINT "patient_health_status_patientId_fkey" FOREIGN KEY ("patientId") REFERENCES "patients"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
